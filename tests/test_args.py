...
# %%
def test_args_matuszynska2016_npq() -> None:
    ...
    pd.testing.assert_frame_equal(
        args,
        pd.read_csv(
            DIR / "assets" / "matuszynska-2016-npq-args-by-ppfd.csv",
            index_col=0,
        ).loc[args.index, args.columns],
        atol=1e-10,
        rtol=1e-10,
    )
...
# %%
def test_args_matuszynska2016_phd() -> None:
    ...
    pd.testing.assert_frame_equal(
        args,
        pd.read_csv(
            DIR / "assets" / "matuszynska-2016-phd-args-by-ppfd.csv",
            index_col=0,
        ).loc[args.index, args.columns],
        atol=1e-10,
        rtol=1e-10,
...
# %%
def test_args_matuszynska2019() -> None:
    ...
    pd.testing.assert_frame_equal(
        args,
        pd.read_csv(
            DIR / "assets" / "matuszynska-2019-args-by-ppfd.csv",
            index_col=0,
        ).loc[args.index, args.columns],
        atol=1e-10,
        rtol=1e-10,
...
def test_args_saadat2021() -> None:
    ...
    pd.testing.assert_frame_equal(
        args,
        pd.read_csv(
            DIR / "assets" / "saadat-2021-args-by-ppfd.csv",
            index_col=0,
        ).loc[args.index, args.columns],
        atol=1e-10,
        rtol=1e-10,
...
# %%
def test_args_poolman2000() -> None:
    ...
    args = pd.DataFrame(
        {
            i: model.update_parameter(
                names.e0(names.rubisco_carboxylase()), i
            ).get_args(
                y0,
                include_time=False,
                include_derived_parameters=True,
    ...
    pd.testing.assert_frame_equal(
        args,
        pd.read_csv(
            DIR / "assets" / "poolman-2000-args-by-influx.csv",
            index_col=0,
        ).loc[args.index, args.columns],
        atol=1e-10,
        rtol=1e-10,
...
def test_args_yokota1985() -> None:
    ...
    pd.testing.assert_frame_equal(
        args,
        pd.read_csv(
            DIR / "assets" / "yokota-1985-args-by-influx.csv",
            index_col=0,
        ).loc[args.index, args.columns],
        atol=1e-10,
        rtol=1e-10,
